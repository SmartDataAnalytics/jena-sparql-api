...
public class BinaryRelation
	implements Relation // TODO Actually we could just extend RelationImpl
{
    private Var sourceVar;
    private Var targetVar;
    private Element element;

    public BinaryRelation(Element element, Var sourceVar, Var targetVar) {
    ...
    public BinaryRelation reverse()
    {
        BinaryRelation result = new BinaryRelation(element, targetVar, sourceVar);
        return result;
    }
    ...
    public BinaryRelation applyNodeTransform(NodeTransform nodeTransform) {
        ...
        BinaryRelation result = new BinaryRelation(e, s, t);
        return result;
    }

    public static BinaryRelation create(org.apache.jena.sparql.path.Path path) {
        BinaryRelation result = new BinaryRelation(ElementUtils.createElement(new TriplePath(Vars.s, path, Vars.o)), Vars.s, Vars.o);
        return result;
    }
     ...
     * @return
     */
    public static boolean isEmpty(BinaryRelation relation) {
        boolean result;
    ...
    public static BinaryRelation empty() {
    	return new BinaryRelation(new ElementGroup(), Vars.s, Vars.s);
    }

    public static BinaryRelation empty(Var var) {
    	return new BinaryRelation(new ElementGroup(), var, var);
    }
}
