...
> :wrench: Many usage examples can be found at the [RDF Processing Toolkit Documentation](https://github.com/SmartDataAnalytics/RdfProcessingToolkit/tree/develop/doc) which is an application of this module.
