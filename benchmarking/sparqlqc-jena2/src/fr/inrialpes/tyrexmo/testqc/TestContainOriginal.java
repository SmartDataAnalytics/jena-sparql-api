...
public class TestContainOriginal {
    final static Logger logger = LoggerFactory.getLogger( TestContainOriginal.class );
	...
	new TestContainOriginal().run( args );
    }
