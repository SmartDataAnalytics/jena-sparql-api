...
public interface RdfPersistenceContext
{
    ...
    //void requestResolution(Object entity, String propertyName, Node node);
    void requestResolution(EntityOps entityOps, Object entity, String propertyName, Node node);
    ...
    //Node getId(Object entity, )
    
    // Return the primary nod for an entity
