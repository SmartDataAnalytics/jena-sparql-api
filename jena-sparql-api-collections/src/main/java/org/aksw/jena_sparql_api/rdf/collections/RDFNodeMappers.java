...
//	}
	...
	public static <T> RDFNodeMapper<T> from(Class<T> viewBaseClass, TypeMapper typeMapper, TypeDecider typeDecider, boolean isViewAll) {
		return new RDFNodeMapperImpl<T>(viewBaseClass, typeMapper, typeDecider, isViewAll);
	}
