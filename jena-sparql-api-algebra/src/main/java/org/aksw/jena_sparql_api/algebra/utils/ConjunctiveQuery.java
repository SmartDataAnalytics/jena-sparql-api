...
public class ConjunctiveQuery {
    ...
    public ConjunctiveQuery applyNodeTransform(NodeTransform transform) {
        QuadFilterPatternCanonical newqfpc  = qfpc.applyNodeTransform(transform);
        VarInfo newProjection = projection.applyTransform(transform);

        return new ConjunctiveQuery(newProjection, newqfpc);
    }
