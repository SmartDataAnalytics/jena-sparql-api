    ...
    implements MapService<Concept, Node, DatasetGraph>
{
    ...
    public MapServiceResourceShapeDataset(QueryExecutionFactory qef,
    ...
    public static MapServiceResourceShapeDataset create(QueryExecutionFactory qef, ResourceShape resourceShape, boolean isLeftJoin) {
